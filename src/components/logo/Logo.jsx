      ...
      >
        ...
        <g clip-path="url(#b)">
          <linearGradient
            ...
            id="c"
          >
            <stop offset=".003" stop-color="#d6e6a6" />
            <stop offset="1" stop-color="#d3deaa" />
          </linearGradient>
          <path
            d="M63.124 14.592c2.887 6.931 3.308 15.017.617 22.867-4.875 14.222-19.915 4.932-31.567-8.167-5.806 1.757-10.833 2.811-14.846 3.692-11.37 2.5-14.634 3.651-4.626 15.698 17.673 21.273 35.466 11.104 47.129-4.084a76.84 76.84 0 005.719-8.633V12.924c-.813.573-1.622 1.13-2.426 1.668z"
            fill="url(#c)"
          />
          <linearGradient
            y2="29.595"
          ...
          >
            ...
            <stop offset=".329" stop-color="#bfcf83" />
            <stop offset="1" stop-color="#9eba56" />
          </linearGradient>
          <path
            d="M63.741 37.459c2.69-7.851 2.27-15.937-.617-22.867-11.585 7.761-22.163 12.042-30.95 14.7 11.652 13.099 26.692 22.389 31.567 8.167z"
            fill="url(#d)"
          />
          <linearGradient
            gradientTransform="matrix(-42.0394 -40.716 -40.8604 44.6021 668.183 -23204.914)"
            y2="282.974"
            x2="-259.972"
            y1="283.2"
            x1="-260.786"
            ...
            id="e"
          >
            <stop offset=".003" stop-color="#cfe294" />
            <stop offset=".173" stop-color="#b9d187" />
            <stop offset=".522" stop-color="#87b268" />
            <stop offset="1" stop-color="#338d45" />
          </linearGradient>
          <path
            d="M63.124 14.592C57.249.487 41.11-8.817 19.831-1.489 18.092-.89 17.323.6 17.328 2.695v.014c.023 6.096 6.583 17.297 14.846 26.584 8.787-2.659 19.365-6.94 30.95-14.701z"
            fill="url(#e)"
          />
        </g>
        <g clip-path="url(#b)" opacity=".92">
          <defs>
            <path
              d="M42.988 26.913C31.838-7.343 8.201-10.813 1.042 16.167-13.453 70.808 47.417 40.52 42.988 26.913z"
              id="f"
            />
          </defs>
          <clipPath id="h">
          ...
          <radialGradient
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(23.4752 0 0 -23.4752 6109.237 6565.986)"
            r="1"
            cy="278.66"
            cx="-259.252"
            id="g"
          >
            ...
            <stop offset=".092" stop-color="#1f2428" />
            <stop offset=".214" stop-color="#35404a" />
            <stop offset=".34" stop-color="#46596b" />
            <stop offset=".467" stop-color="#536f8a" />
            <stop offset=".595" stop-color="#5c80a4" />
            <stop offset=".725" stop-color="#618db8" />
            <stop offset=".859" stop-color="#6595c6" />
            <stop offset="1" stop-color="#69c" />
          </radialGradient>
          <path
            fill="url(#g)"
            clip-path="url(#h)"
            d="M-11.212-9.377h60.868v81.62h-60.868z"
          />
        </g>
        <defs>
          <path
            d="M0 27.812c0 6 1.82 11.578 4.938 16.207 13.094-2.063 27.898-13.127 25.693-20.381C27.46 13.206 22.737 5.72 17.877.981 7.379 5.362 0 15.726 0 27.812"
            id="i"
          />
        </defs>
        <clipPath id="k">
        ...
        <radialGradient
          gradientUnits="userSpaceOnUse"
          gradientTransform="matrix(3.5698 -31.4823 -18.6516 -2.0091 6187.974 -7676.08)"
          r="1"
          cy="281.051"
          cx="-262.404"
          id="j"
        >
          ...
          <stop offset=".117" stop-color="#cadbed" />
          <stop offset=".3" stop-color="#a5c1e1" />
          <stop offset=".483" stop-color="#89aed7" />
          <stop offset=".662" stop-color="#76a2d1" />
          <stop offset=".837" stop-color="#6a9bcd" />
          <stop offset="1" stop-color="#69c" />
        </radialGradient>
        <path
          fill="url(#j)"
          clip-path="url(#k)"
          d="M37.721 1.501l-5.218 46.02L-4.821 43.5.397-2.519z"
        />
      </svg>
    </>
  );
